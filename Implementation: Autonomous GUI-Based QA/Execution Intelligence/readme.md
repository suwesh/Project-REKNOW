...
- `windows-runtime/`: Windows-side execution controller, multimodal intent selection, deterministic target resolution, GUI actuation, screen-state storage, action validation, and evidence compilation.
